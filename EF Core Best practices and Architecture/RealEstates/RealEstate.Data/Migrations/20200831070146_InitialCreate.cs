    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyTypies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RealEstateProperties_PropertyTypies_PropertyTypeId",
                        column: x => x.PropertyTypeId,
                        principalTable: "PropertyTypies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealEstatePropertiesTags", x => new { x.RealEstatePropertyId, x.TagId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealEstatePropertiesTags_TagId",
