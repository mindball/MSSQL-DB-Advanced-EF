namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        {            
            var xmlSerializer = new XmlSerializer(typeof(ProjectWithTasksDto[]),
                                new XmlRootAttribute("Projects"));

            var projectDtos = (ProjectWithTasksDto[])xmlSerializer
        ...
        private static bool IsValidTaskDto(TaskDto task)
        {
