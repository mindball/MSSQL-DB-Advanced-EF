namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        private static void ExportEntities(BookShopContext context, string exportDir)
        {
            ...
            var authors = DataProcessor.Serializer.ExportMostCraziestAuthors(context);
            Console.WriteLine(authors);
            File.WriteAllText(exportDir + "Actual Result - ExportMostCraziestAuthors.json", authors);
