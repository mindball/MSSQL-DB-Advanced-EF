...
namespace Lesson.Test.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<CustomersGermany> CustomersGermany { get; set; }
        public virtual DbSet<DeletedEmployees> DeletedEmployees { get; set; }
        public virtual DbSet<Departments> Departments { get; set; }
        public virtual DbSet<EmployeeSalaryCondition> EmployeeSalaryCondition { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomersGermany>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<DeletedEmployees>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PK__Deleted___7AD04F117A69592C");
            ...
            modelBuilder.Entity<EmployeeSalaryCondition>(entity =>
            {
                entity.HasNoKey();
